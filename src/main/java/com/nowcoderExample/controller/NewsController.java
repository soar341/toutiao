...
import com.nowcoderExample.model.*;
import com.nowcoderExample.service.*;
...
public class NewsController {
    ...
    public String newDetails(@PathVariable("newsId")int newsId,Model model){
        ...
        if(news!=null){
            ...
            model.addAttribute("comments",commentVOs);//对应于detail.html 中comments
        }
